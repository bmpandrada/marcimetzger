...
const HeroPlayFadeWallpaper = ({ image, alt }) => {
  const imageSrc = image || "/images/hero/hero-image.webp";
  const imageAlt = alt || "hero";
  return (
    <div className='w-full px-4'>
      <div className='wow fadeInUp relative z-10 mx-auto max-w-[845px]' data-wow-delay='.25s'>
        <div className='mt-16'>
          <img src={imageSrc} alt={imageAlt} className='max-w-full mx-auto rounded-t-xl rounded-tr-xl' />
        </div>
...
export default React.memo(HeroPlayFadeWallpaper);
