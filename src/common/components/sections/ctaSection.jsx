          ...
          <div className='flex flex-wrap items-stretch -mx-4'>
            <div className='w-full px-4'>
              <div className='mx-auto max-w-[570px] text-center'>
                ...
                <p className='mx-auto mb-6 max-w-[515px] text-base leading-normal text-white'>There are many variations of passages of Lorem Ipsum but the majority have suffered in some form.</p>
                <a href='#listings' className='inline-block rounded-md border border-transparent bg-secondary px-7 py-3 text-base font-medium text-white transition hover:bg-[#0BB489]'>
