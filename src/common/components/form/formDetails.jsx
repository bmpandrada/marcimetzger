    ...
    <div className='w-full px-4 lg:w-7/12 xl:w-8/12'>
      <div className='ud-contact-content-wrapper'>
        <div className='ud-contact-title mb-12 lg:mb-[150px]'>
          <span className='block mb-6 text-base font-medium text-dark dark:text-white'>CONTACT US</span>
          <h2 className='max-w-[260px] text-[35px] leading-[1.14] font-semibold text-dark dark:text-white'>Let's talk about your problem.</h2>
        </div>
        <div className='flex flex-wrap justify-between mb-12 lg:mb-0'>
          <div className='flex flex-wrap justify-between mb-12 lg:mb-0'>
            <div className='mb-8 flex w-[330px] max-w-full'>
              ...
              <div>
                <h5 className='mb-[18px] text-lg font-semibold text-dark dark:text-white'>Marci Metzger - THE RIDGE REALTY GROUP</h5>
                <p className='text-base text-body-color dark:text-dark-6'>3190 HW-160, Suite F, Pahrump, Nevada 89048, United States</p>
                <p className='text-base text-body-color dark:text-dark-6'>(206) 919-6886</p>
              </div>
            </div>
            <div className='mb-8 flex w-[330px] max-w-full'>
              <div className='mr-6 text-[32px] text-primary'>
              ...
              <div>
                <h5 className='mb-[18px] text-lg font-semibold text-dark dark:text-white'>Office Hours</h5>
                <p className='text-base text-body-color dark:text-dark-6'>Open today 08:00 am – 07:00 pm</p>
                <p className='mt-1 text-base text-body-color dark:text-dark-6'>Appointments outside office hours available upon request. Just call!</p>
              </div>
            </div>
          </div>
        </div>
